...
namespace MessengerApp
{
    ...
    public sealed partial class ItemPage : Page
    {
       ...
       // private readonly ObservableDictionary defaultViewModel = new ObservableDictionary();
        ...
        {
            await vm.getMsgs(vm.emailThisSession, vm.passwordThisSession);                  // Calling get Messages 
        }
        ...
        {
            string msg = TypeMessage.Text;
            if(!msg.Equals(""))
            {
                await vm.msgSend(vm.passwordThisSession, vm.passwordThisSession, msg, "dha3142@rit.edu");           //sending messages
            }
